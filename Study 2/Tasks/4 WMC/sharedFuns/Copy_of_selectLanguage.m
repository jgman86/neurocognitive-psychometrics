...
set(languageSelectionFigure, 'Position',[scrsz(3)/3 scrsz(4)/3 scrsz(3)/3 scrsz(4)/3]);
...
dl_filename = strcat('.\LANGUAGES\defaultLang.csv');
...
% linkTextButton = uicontrol(languageSelectionFigure,'Style','pushbutton',...
%         'String','No support for your language?   How to implement a new language',...
%         'Enable','on',...
%         'Position',[160 120 400 70],...
%         'ForegroundColor', [0 0 1],...
%         'BackgroundColor',colorOfFigureWindow);
%     % set(linkTextButton,'Visible', 'off');
%     set(linkTextButton,'Callback',@howTo_Callback);

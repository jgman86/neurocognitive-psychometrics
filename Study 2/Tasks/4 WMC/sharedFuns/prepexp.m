...
%screenparms.w = Screen(screenparms.window,'RectRight')-Screen(screenparms.window,'RectLeft');
%screenparms.h = Screen(screenparms.window,'RectBottom')-Screen(screenparms.window,'RectTop');
% screenparms.w = screenparms.rect(3)-screenparms.rect(1);
% screenparms.h = screenparms.rect(4)-screenparms.rect(2);
screenparms.h = screenparms.rect(RectBottom) - screenparms.rect(RectTop);
screenparms.w = screenparms.rect(RectRight) - screenparms.rect(RectLeft);

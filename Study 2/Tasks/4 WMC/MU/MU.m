...
function rc=MU(subject,sex,year,screenparms, expMessage)
global ptb3
...
try %catch errors for entire function and all subsidiaries
    ...
    datafile =    ['..\Data\MU-' int2str(subject) '-' int2str(sex) '-' int2str(year) '.dat'];
    ...
    %::::::::::::::::: now record data
    for i=Npracticetrials+1:Npracticetrials+Ntesttrials
        %fprintf (fid, '%3d %3d %3d %3d  ', subject, sex, year, i );
        fprintf (fid, '%3d  ', i );
        for j=1:6

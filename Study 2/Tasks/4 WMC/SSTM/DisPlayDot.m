...
function DisPlayDot(screenparms,Text,Time,Trial,NumIndex,AdjH,AdjV,RecTrial,Dot,Board,WindowPtr,expMessage)
...
SSTMText(expMessage(13,:),'Arial',Text.Size3,Text.Color1,250,WindowPtr,AdjH,AdjV);

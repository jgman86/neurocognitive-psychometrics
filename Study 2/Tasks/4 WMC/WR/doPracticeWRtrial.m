...
function doPracticeWRtrial(screenparms, expinfo, arrayLength, wordletters, nonwordletters, retrievedLetters, instrDir)
global ptb3
...
for positionseq = randperm(arrayLength);       
    ...
    for position = startposition+positionseq-1
        %CenteredText(screenparms, '+', position*gap+(position-.5)*expinfo.frameW, screenparms.h/2, 1);

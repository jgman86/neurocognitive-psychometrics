...
prompt = {'Name','Vorname','Alter:','Geschlecht (m/w):','Studienfach:', 'Links- oder Rechtshänder:','Eigene Motivation (1-5)','Empfundene Schwierigkeit (1-5)','E-Mail (freiwillige Angabe)'};
...
expinfo.Motivation = answer{7};
expinfo.Difficulty = answer{8};
expinfo.subjectbio.Contact = answer{9};
...
fprintf(fid, '%s ', expinfo.subjectbio.Motivation);
fprintf(fid, '%s', expinfo.subjectbio.Difficulty);

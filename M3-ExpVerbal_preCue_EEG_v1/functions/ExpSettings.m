...
expinfo.Fixtime = 0.2; % Dauer des Fixationskreuzes zu Beginn eines Trials
expinfo.Fix_jitter = 0.05; % Jitter des Fixaxtionskreuzes

expinfo.Fix_Cue = 1.2;
expinfo.fix_cue_jitter = 0.25;

expinfo.Cue_Word = 1.2;
expinfo.Cue_Word_jitter = 0.25;

expinfo.cue_time = 0.250;
expinfo.cue_jitter = 0.05;

expinfo.ISI = 0.250; % Minimale Dauer des Inter-Stimulus-Intervalls (ISI)
expinfo.ISI_jitter = 0.20; % ISI Jitter = Intervall in dem das ISI variieren darf

expinfo.ISI_Ret = 1; % Minimale Dauer des Inter-Stimulus-Intervalls im Retrieval(ISI)
expinfo.ISI_Ret_jitter = 0.20; % ISI Jitter = Intervall in dem das ISI variieren darf
